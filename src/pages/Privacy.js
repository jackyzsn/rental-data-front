    ...
    <div>
      ...
      <div>
        ...
        <p>
          ...
          Conditions, which is accessible at FindMyHouse unless otherwise defined in this Privacy
          Policy.
        </p>
        <p>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              <a
                href="https://consumer.huawei.com/minisite/cloudservice/hiapp/privacy-statement.htm?country=CN&amp;branchid=2&amp;language=en_US"
                target="_blank"
                rel="noreferrer"
              >
                Huawei
        ...
        <p>
          ...
          (&ldquo;IP&rdquo;) address, device name, operating system version, the configuration of
        ...
        <p>
          This Service does not use these &ldquo;cookies&rdquo; explicitly. However, the app may use
          third party code and libraries that use &ldquo;cookies&rdquo; to collect information and
        ...
        <p>
          ...
          contact us at jacky.zsn@gmail.com.
        </p>
        <p>
